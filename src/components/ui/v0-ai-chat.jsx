...
export function VercelV0Chat() {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            setMessages((prev) => [
                ...prev,
                { role: "assistant", content: "Error: Failed to get response from Gemini. Please check your API key in the .env file." }
            ]);
        } finally {
            setIsLoading(false);
        }
    ...
    return (
        <div className="flex flex-col items-center w-full max-w-4xl mx-auto px-4 sm:px-6 h-[88vh] sm:h-[85vh]">
            ...
            >
                {messages.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full space-y-8 sm:space-y-12 animate-in fade-in duration-700 mt-[-10vh]">
                    ...
                    messages.map((msg, idx) => (
                        <div
                            key={idx}
                            className={cn(
                                "flex items-start gap-2 sm:gap-4 animate-in slide-in-from-bottom-2 duration-300",
                ...
                <div className="relative bg-black/60 backdrop-blur-3xl rounded-xl sm:rounded-2xl border border-white/10 shadow-[0_0_50px_-12px_rgba(0,0,0,0.8)] overflow-hidden transition-all duration-300 focus-within:border-purple-500/40 focus-within:ring-1 focus-within:ring-purple-500/20">
                    <div className="overflow-y-auto">
                        <Textarea
                            ...
                            placeholder="Message Agentic Solutions..."
                            className={cn(
